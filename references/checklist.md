...
- [ ] The page type is identified before layout choices are made.
- [ ] The old Portfolio gray-green is not treated as the system color.
- [ ] The old retro-computer/window-like Portfolio article style is not preserved.
...
- [ ] Ze character art appears only when it supports a concept, state, or action.
- [ ] Article components are selected after reading the article text; cards, quotes, callouts, paths, figures, and motion come from the content.
- [ ] Text does not overlap, clip, or overflow on desktop or mobile.
- [ ] Style references are not treated as content images; reference subjects are not copied, redrawn, or turned into Ze symbols or figures.
- [ ] Text-bearing cards, tags, captions, controls, and figure labels use explicit surface / ink pairs with readable contrast.
- [ ] Complex pages define enough local layout intent that title, body, figures, controls, navigation, and decorative layers cannot collide.
- [ ] Missing images do not appear as fake placeholders, empty boxes, plus-sign frames, or generic side panels.
- [ ] Label-to-title spacing is system-level and consistent; no cramped tag/kicker/meta title groups.
- [ ] Focus states are visible.
- [ ] Motion honors `prefers-reduced-motion`.
- [ ] Content remains visible without JavaScript-triggered reveal classes.
- [ ] Interactive examples include hover/focus/active/selected states where relevant.
- [ ] No default browser blockquote, table, or list styling appears in final designed surfaces.
...
- [ ] Parallel track cards have equal visual weight unless the content intentionally creates hierarchy.
- [ ] Illustration placement uses an explicit size mode: hero spot, side anchor, inline figure, or thumbnail.
- [ ] Page density, motion, visual weight, and component complexity fit the page type rather than blindly applying one style everywhere.

## P2 Polish

- [ ] Dot or another Ze symbol supports a real interaction.
